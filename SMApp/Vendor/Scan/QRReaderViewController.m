...
- (void)initViewAndSubViews {
    ...
    UIImageView *topLeft =
    [[UIImageView alloc] initWithFrame:CGRectMake(40,
                                                  40,
    ...
    [[UIImageView alloc] initWithFrame:CGRectMake(kScreenWidth-60,
                                                  40,
                                                  edgeLength, edgeLength)];
    ...
    UIView *topLine =
    [[UIView alloc] initWithFrame:CGRectMake(40,
                                             40,
                                             kScreenWidth-80, 1)];
    ...
    UIView *rightLine =
    [[UIView alloc] initWithFrame:CGRectMake(kScreenWidth-40,
                                             40,
                                             1, kScreenWidth-80)];
    ...
    // 控制散光灯
        ...
        [[UIButton alloc] initWithFrame:CGRectMake(kScreenWidth/2-35, kScreenHeight-160, 70, 70)];
    [torchSwitch setBackgroundImage:[UIImage imageNamed:@"closeLight"] forState:UIControlStateNormal];
        torchSwitch.layer.cornerRadius = 35.0;

        [torchSwitch addTarget:self action:@selector(torchSwitch:) forControlEvents:UIControlEventTouchDown];
...
- (void)torchSwitch:(UIButton*)sender {
    ...
    if (sender.selected == NO) {
        [sender setBackgroundImage:[UIImage imageNamed:@"closeLight"] forState:UIControlStateNormal];

    }else{
    
        [sender setBackgroundImage:[UIImage imageNamed:@"openLighe"] forState:UIControlStateNormal];
    }
...
//    
    ...
    [UIView animateWithDuration:LINE_SCAN_TIME - 0.05
                     animations:^{
                         ...
                         scanLineframe.origin.y = kScreenWidth-50;
